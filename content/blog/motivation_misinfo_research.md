...
One strategy for this has been to analyze the properties of online content and misinformation, and using this to develop more realistic evaluation protocols of moderation systems. By incorporating elements of these evaluation protocols into the model training phase, we get models that are inherently more robust to changes in content than before.
